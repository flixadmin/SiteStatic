...
<a href="/p/player.html?id=${window.post_id}" role="button" class="block my-2 mx-auto px-4 py-2 w-max bg-emerald-600/[.85] text-white leading-none rounded-md text-xl ease-out duration-300 active:scale-[.9] hover:bg-emerald-600 dark:bg-emerald-400/75 dark:hover:bg-emerald-500/75">Watch Online</a>
